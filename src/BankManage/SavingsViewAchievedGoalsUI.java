...
public class SavingsViewAchievedGoalsUI extends JFrame implements ActionListener {
    ...
    public SavingsViewAchievedGoalsUI(String setUser) {
        ...
        // head
        headerLbl = new JLabel("Achieved Goals");
    ...
    private void loadAchievedCards(String userId) {
        ...
        if (goals.isEmpty()) {
            // walang completed goals pa
            JLabel emptyLbl = new JLabel("No achieved goals yet.");
            ...
            for (savingsModels goal : goals) {
                JPanel card = buildAchievedCard(goal, savingsService);
    ...
    // forms a achieved goal card - read only, may remove button lang
    private JPanel buildAchievedCard(savingsModels goal, SavingsService savingsService) {
        ...
        // completed status badge - laging green dito kasi completed na lahat
        ...
        // remove btn action - tatanggalin sa database
